...
public class RobotContainer {
    ...
    public final Command asleepCommand = Commands.parallel(
            ...
            Commands.sequence(new WaitCommand(Constants.Autonomous.sleepingExtruderDelay),
                    new ExtruderinatorManualControl(m_extruderinator, () -> Constants.Extruderinator.autonomousSpeed)
                            .withTimeout(15 - Constants.Autonomous.sleepingExtruderDelay
                                    - Constants.Autonomous.sleepingDuration)));
    /*
    ...
    // Double to prevent unexpected casting, not sure if needed
    private double m_drivePolarity = 1;
    ...
    private void configureBindings() {
        ...
        m_drivetrain.setDefaultCommand(new DriveArcade(
                m_drivetrain,
                () -> Math.pow(-m_driverController.getRawAxis(Constants.Control.moveAxis) * m_drivePolarity, 3.0),
        ...
        m_operatorController.button(Constants.Control.clawManualOpenButton)
                .onTrue(new ClawManualControl(m_claw, () -> Constants.Claw.manualOpenSpeed)); // Button X - Open
        m_operatorController.button(Constants.Control.clawManualCloseButton)
                .onTrue(new ClawManualControl(m_claw, () -> Constants.Claw.manualCloseSpeed)); // Button B - Close

        m_operatorController.button(Constants.Control.clawManualOpenButton)
                .onFalse(new ClawManualControl(m_claw, () -> Constants.Claw.manualStopSpeed)); // Button X - Open
        m_operatorController.button(Constants.Control.clawManualCloseButton)
                .onFalse(new ClawManualControl(m_claw, () -> Constants.Claw.manualStopSpeed)); // Button B - Close
